...
## Output:
## 1. Block.x=1023
![output](https://github.com/RuchithaReddy28/PCA-GPU-based-vector-summation.-Explore-the-differences./blob/main/o1.png?raw=true)

## 2. Block.x=1024
![output](https://github.com/RuchithaReddy28/PCA-GPU-based-vector-summation.-Explore-the-differences./blob/main/o2.png?raw=true)

## 3. Block.x=256
![output](https://github.com/RuchithaReddy28/PCA-GPU-based-vector-summation.-Explore-the-differences./blob/main/o3.png?raw=true)
